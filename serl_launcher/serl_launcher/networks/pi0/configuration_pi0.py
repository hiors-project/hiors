...
class PI0Config(PreTrainedConfig):
    ...
    #         'observation.velocity': PolicyFeature(type=FeatureType.STATE, shape = (14,)),
    ...
    image_features = {"cam_high": PolicyFeature(type=FeatureType.VISUAL, shape=(3, 480, 640)),
                      'cam_left_wrist': PolicyFeature(type=FeatureType.VISUAL, shape=(3, 480, 640)),
                      'cam_right_wrist': PolicyFeature(type=FeatureType.VISUAL, shape=(3, 480, 640))}

    action_feature = PolicyFeature(type=FeatureType.ACTION, shape=(14, ))
